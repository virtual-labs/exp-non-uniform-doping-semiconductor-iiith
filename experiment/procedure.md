...
#### Task 2
###### Step-1
Identify which plot is uniformly doped junction, linearly graded junction and hyperabrupt junction. 
###### Step-2
There are 3 space charge density plots on the left, one of each type. 
###### Step-3
The user is to match each plot to its correct label on the right and press submit button to verify their answers
